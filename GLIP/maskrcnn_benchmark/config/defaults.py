...
_C.PROMPT = CN()
_C.PROMPT.PROMPT_DEPTH = 8
_C.PROMPT.DIFFUSION = CN()
_C.PROMPT.DIFFUSION.SAMPLE_DISTANCE = 5
_C.PROMPT.TYPE = 'Mask-VPT' # VPT, Sprompts, MaPLe, Mask-VPT
_C.PROMPT.PROMPT_LENGTH = 8
_C.PROMPT.ENABLE = True
_C.PROMPT.VISUAL_PROMPT = True
_C.PROMPT.VISUAL_GLOBAL_PROMPT = True
_C.PROMPT.TEXTUAL_PROMPT = True
_C.PROMPT.TEXTUAL_GLOBAL_PROMPT = True