...
def main():
    ...
    parser.add_argument(
        ...
        default='configs/pretrain/glip_A_Swin_T_O365.yaml',
        metavar="FILE",
    ...
    parser.add_argument(
        "--weight",
        # default=None,
        default='result/finetune_refcoco_diff_prompt_v3/ft_task_1/model_final.pth',
        metavar="FILE",
        help="path to config file",
    )
    ...
    parser.add_argument("--task_config", default='configs/refcoco/val.yaml')
    ...
    log_dir = os.path.join(log_dir, "visualize")
    if args.weight:
        ...
        for task_config in all_task_configs:
            ...
            if log_dir:
                ...
                predictions = inference(
                    ...
                    visualize_param=visualize_param,
